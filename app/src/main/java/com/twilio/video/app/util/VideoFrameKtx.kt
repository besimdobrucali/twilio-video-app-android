...
fun VideoFrame.toMat() : Mat {
    ...
    return i420ToMat(i420Buffer, buffer.width, buffer.height)
}

private fun i420ToMat(i420Buffer: VideoFrame.I420Buffer, width: Int, height: Int): Mat {
    ...
    val yPlane = yuvPlanes[0].asReadOnlyBuffer()
    val uPlane = yuvPlanes[1].asReadOnlyBuffer()
    val vPlane = yuvPlanes[2].asReadOnlyBuffer()

    yPlane.get(yuvBytes, 0, width * height)

    val chromaRowStride = yuvStrides[1]
